...
fc.cutoff = 2 #fold change cutoff, 1.5-2 depending on number of results...
...
for (comp in comparision) 
{
  ...
  plotVolcano(results_contrast=results_contrast, contrast= c(comp[1],comp[2], comp[3]), fcval=fc.cutoff, fc.max=maxfc, fdrval=alpha)
  ...
  plotMA(results_contrast=results_contrast, contrast= c(comp[1],comp[2], comp[3]), fc.max=maxfc, fdrval=alpha)
